...
class Posts extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Link className="back_btn dropdown-item" to="/">
          {" "}
        ...
        <div className="container project-page">
          <div className="row">
            ...
            <div className="col-md-7" id="project-name">
              {projectObj.name}
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-7">{projectObj.technoloy}</div>
          </div>

          <div className="row desc">
            <div className="col-md-3">Description:</div>
            <div className="col-md-7">{projectObj.description}</div>
          </div>

          <div className="row">
            <div className="col-md-3">Screenshot:</div>
            <div className="col-md-7">
              <img src={projectObj.image}></img>
            </div>
          </div>
        </div>
      </React.Fragment>
